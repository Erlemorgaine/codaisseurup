...
Booking.create!(event: event1, user: erle, total: 100, starts_at: 10.days.from_now, ends_at: 12.days.from_now)
Booking.create!(event: event1, user: dino, total: 200, starts_at: 20.days.from_now, ends_at: 24.days.from_now)
