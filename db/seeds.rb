...
event1 = Event.create!(name: "Yann Tiersen concert", description: "blabla", location: "Mainz", price: 35, capacity: 100, includes_food: false, includes_drinks: false, starts_at: 30.days.from_now, ends_at: 30.days.from_now, active: true, user: erle)
...
event3 = Event.create!(name: "Wildernes festival", description: "blabla", location: "Leiden", price: 12.25, capacity: 1500, includes_food: false, includes_drinks: true, starts_at: 24.days.from_now, ends_at: 28.days.from_now, active: true, user: erle)
...
Booking.create!(event: event1, user: erle, total: 100, starts_at: 10.days.from_now, ends_at: 12.days.from_now, guest_count: 3, status: true)
Booking.create!(event: event1, user: erle, total: 200, starts_at: 20.days.from_now, ends_at: 24.days.from_now, guest_count: 2, status: true)
Booking.create!(event: event1, user: erle, total: 200, starts_at: 20.days.from_now, ends_at: 24.days.from_now, guest_count: 1, status: true)
